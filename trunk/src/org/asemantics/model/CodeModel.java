...
import org.asemantics.RDFCoder;
...
public abstract class CodeModel implements BackTrackingSupport {
    ...
    /**
     * Allows to add triples into the org.asemantics.model.
     * @param subject
     * @param predicate
     * @param object
     */
    ...
    /**
     * Allows to remove a triple from the org.asemantics.model.
     * @param subject
     * @param predicate
     * @param object
     */
    ...
    /**
     *  Remove the entire content of the org.asemantics.model.
     */
